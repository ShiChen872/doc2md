...
`--html` on `doc2md.py` writes a sidecar `.html` from the Markdown (same assets). Structured docs become a handbook-style reading page; PPT / page decks become per-page talk cards (screenshot above notes).
